...
void Autons::tuning()
{
  ...
  // chassisReference->driveDistance(30, 0, driveParams30_in(), turnParams10_deg(), {.sendPositionData = true});

  // Drive 50 inches forward
  // chassisReference->driveDistance(50, 0, driveParams50_in(), turnParams10_deg(), {.sendPositionData = true});
}