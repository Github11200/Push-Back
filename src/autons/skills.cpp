...
void Autons::skills()
{
  ...
  chassisReference->turnTo(Pose<double>(-11, 11, -360), {}, {.forwards = false});
  ...
  chassisReference->driveToPoint(Pose<double>(-20, 62, 0), {.driveTimeout = 1300}, {}, {.forwards = false});
  willyNilly.off();
  intake.stopFullIntake();
  ...
  chassisReference->driveToPoint(Pose<double>(42, 60, 0), {}, turnParams10_deg(), {.forwards = false});
  ...
  chassisReference->turnTo(Pose<double>(64, 30, -360), {}, {});
  chassisReference->driveToPoint(Pose<double>(64, 30, 0), {}, turnParams10_deg(), {});
  ...
  // Align to middle goal
  intake.stopFullIntake();
  chassisReference->turnTo(Pose<double>(13, -10, -360), {}, {.forwards = false});
  sloper.off();
  chassisReference->driveToPoint(Pose<double>(13, -10, 135), {}, turnParams10_deg(), {.forwards = false});

  // Score in middle goal
  IntakeRear.spin(vex::directionType::fwd, 3.5, vex::voltageUnits::volt);
  IntakeMiddle.spin(vex::directionType::fwd, 6, vex::voltageUnits::volt);
  IntakeFront.spin(vex::directionType::fwd, 12, vex::voltageUnits::volt);
  wait(2000, msec);
  sloper.on();
  intake.stopFullIntake();
  ...
  chassisReference->driveToPoint(Pose<double>(10, -62, 90), {}, {}, {.forwards = false});
  willyNilly.off();
  intake.stopFullIntake();

  // Drive through alleyway
  chassisReference->turnTo(Pose<double>(-42, -55, -360), {}, {.forwards = false});
  chassisReference->driveToPoint(Pose<double>(-42, -55, 0), {}, {}, {.forwards = false});
  ...
  chassisReference->turnTo(Pose<double>(-63, -20, -360), {}, {});
  chassisReference->driveToPoint(Pose<double>(-63, -20, 0), {}, turnParams10_deg(), {});
  ...
  chassisReference->driveWithVoltage(10, 1300, chassisReference->getAbsoluteHeading().angle, turnParams10_deg(), {});
  wait(10000, msec);
}