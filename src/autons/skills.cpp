...
void Autons::skills()
{
  ...
  chassisReference->driveToPoint(Pose<double>(-70, -46, 0), {.driveTimeout = 3000, .driveMaxVoltage = 4}, {}, {}); // Drive into the dispenser for 3 seconds
  ...
  chassisReference->driveToPoint(Pose<double>(-39, 47.7, 0), {}, {}, {});

  // 2nd long goal
  chassisReference->turnTo(Pose<double>(-20, 47.5, -360), {}, {.forwards = false});
  intake.spinFullIntake(vex::directionType::fwd);
  chassisReference->driveToPoint(Pose<double>(-20, 47.5, 0), {.driveTimeout = 1500, .driveMaxVoltage = 6}, {}, {.forwards = false});
  ...
  chassisReference->driveToPoint(Pose<double>(-20, 47, 0), {.driveTimeout = 1500, .driveMaxVoltage = 6}, {}, {.forwards = false});
  chassisReference->odometry->setPosition(-28.5, 47, chassisReference->getAbsoluteHeading().angle);
  ...
  chassisReference->turnTo(Pose<double>(39, 54, -360), {}, {});
  chassisReference->driveToPoint(Pose<double>(39, 54, 0), {.driveTimeout = 2000}, {}, {});

  // Align to 3rd dispenser
  chassisReference->turnTo(Pose<double>(39, 37.3, -360), {}, {});
  chassisReference->driveToPoint(Pose<double>(39, 37.3, 0), {.driveTimeout = 1000}, {}, {});

  // 3rd dispenser
  willyNilly.on();
  chassisReference->turnTo(Pose<double>(70, 37.3, -360), {}, {});
  intake.spinFullIntake(vex::directionType::fwd);
  chassisReference->driveToPoint(Pose<double>(70, 37.3, 0), {.driveTimeout = 3000, .driveMaxVoltage = 4}, {}, {});

  // Drive back from it
  chassisReference->turnTo(Pose<double>(42, 37.3, -360), {}, {.forwards = false});
  chassisReference->driveToPoint(Pose<double>(42, 37.3, 0), {.driveTimeout = 1200}, {}, {.forwards = false});

  // Go to the other side of the field
  chassisReference->turnTo(Pose<double>(42, -55, -360), {}, {});
  chassisReference->driveToPoint(Pose<double>(42, -55, 0), {}, {}, {});

  // Score on the long goal
  chassisReference->turnTo(Pose<double>(20, -55, -360), {}, {.forwards = false});
  chassisReference->driveToPoint(Pose<double>(20, -55, 0), {.driveMaxVoltage = 6, .driveTimeout = 1500}, {}, {.forwards = false});
  chassisReference->odometry->setPosition(28.5, -47, chassisReference->getAbsoluteHeading().angle);
  ...
  // 4th dispenser
  intake.spinFullIntake(vex::directionType::fwd);
  chassisReference->turnTo(Pose<double>(70, -48, -360), {}, {});
  chassisReference->driveToPoint(Pose<double>(70, -48, 0), {.driveTimeout = 3300, .driveMaxVoltage = 4}, {}, {});

  // Score the blocks from the dispenser again in the 2nd dispenser
  willyNilly.off();
  chassisReference->turnTo(Pose<double>(20, -48, -360), {}, {.forwards = false});
  chassisReference->driveToPoint(Pose<double>(20, -48, 0), {.driveMaxVoltage = 6}, {}, {.forwards = false});
  ...
  chassisReference->turnTo(Pose<double>(30, -47.5, -360), {}, {});
  chassisReference->driveToPoint(Pose<double>(30, -47.5, 0), {}, {}, {});
