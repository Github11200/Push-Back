...
void Autons::high()
{
  ...
  // chassisReference->driveToPoint(Pose<double>(-20, 49, 0), {.driveTimeout = 1100}, turnParams10_deg(), {.forwards = false});
  ...
  // Drive to the middle blocks
  // chassisReference->turnTo(Pose<double>(-23, 23, -360), {}, {});
  chassisReference->driveToPoint(Pose<double>(-24, 22, 0), {.driveTimeout = 900, .driveSettleTime = 0}, {}, {});
  ...
  // Ram into 1st loader
  intake.spinFullIntake(vex::directionType::fwd);
  chassisReference->turnTo(Pose<double>(-68, 46.25, -360), {.turnTimeout = 700, .turnSettleTime = 0, .turnSettleError = 5}, {});
  // chassisReference->driveToPoint(Pose<double>(-80, -47, 0), driveParams, turnParams10_deg(), {});
  chassisReference->driveWithVoltage(12, 100, chassisReference->getAbsoluteHeading().angle, turnParams10_deg(), {});
  chassisReference->driveWithVoltage(5.5, 700, chassisReference->getAbsoluteHeading().angle, turnParams10_deg(), {});

  // Line up to long goal
  chassisReference->turnTo(Pose<double>(-20, 46.5, -360), {.turnTimeout = 300}, {.forwards = false});
  ...
  // Drive away from the long goal
  chassisReference->driveToPoint(Pose<double>(-47, 47, 0), {.driveTimeout = 1100}, {}, {});

  // Lower the sloper for mid gaol
  sloper.off();

  // Turn and drive to the mid goal
  chassisReference->turnTo(Pose<double>(-8, 8, -360), {.turnTimeout = 600}, {.forwards = false});
  chassisReference->driveToPoint(Pose<double>(-8, 8, 0), {.driveTimeout = 1500}, {}, {.forwards = false});
  ...
  // Drive forward and descore
  chassisReference->driveDistance(7, chassisReference->getAbsoluteHeading().angle, {.driveTimeout = 600}, {}, {});
  sloper.on();
  chassisReference->driveWithVoltage(-10, 800, chassisReference->getAbsoluteHeading().angle, {}, {});
}