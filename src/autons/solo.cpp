...
void Autons::solo()
{
  ...
  chassisReference->driveWithVoltage(6.5, 400, chassisReference->getAbsoluteHeading().angle, turnParams10_deg(), {});
  ...
  Brain.Timer.event([](void *)
                    { IntakeFront.spin(vex::directionType::rev, 6.5, volt); }, 100);
