...
CFLAGS    = ${CFLAGS_CL} ${CFLAGS_V7} -O2 -Wall -Werror=return-type -ansi -std=gnu99 $(DEFINES)
CXX_FLAGS = ${CFLAGS_CL} ${CFLAGS_V7} -O2 -Wall -Werror=return-type -fno-rtti -fno-threadsafe-statics -fno-exceptions  -std=gnu++17 -ffunction-sections -fdata-sections $(DEFINES)
